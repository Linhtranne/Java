...
public class EmployeeDaoImp implements EmployeeDao {
    ...
    public int getPageEmployees() {
        ...
        try (Connection conn = ConnectionDB.openConnection();
             CallableStatement stmt = conn.prepareCall("{CALL getEmployees()}");
    ...
    @Override
    public void updateEmployeeSex(String employeeId, Gender sex) {
    ...
    private Employees mapEmployee(ResultSet rs) throws SQLException {
        ...
        e.setSex(Gender.valueOf(rs.getString("sex")));
