    ...
    private static void addEmployee() {
        ...
        while (true) {
            try {
                ...
                sex = Gender.valueOf(sc.nextLine().toUpperCase());
                break;
        ...
        try {
            switch (opt) {
                ...
                case 4 -> {
                    ...
                    Gender sex = Gender.valueOf(sc.nextLine().toUpperCase());
