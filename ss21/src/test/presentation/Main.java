            ...
            try {
                switch (choice) {
                    case 1:
                        ...
                        if (!Validator.isInteger(intInput)) throw new IllegalArgumentException("Lỗi: Bạn phải nhập số nguyên!");
                    ...
                    case 2:
                        ...
                        if (!Validator.isFloat(floatInput)) throw new IllegalArgumentException("Lỗi: Bạn phải nhập số thực float!");
                    ...
                    case 3:
                        ...
                        if (!Validator.isDouble(doubleInput)) throw new IllegalArgumentException("Lỗi: Bạn phải nhập số thực double!");
                    ...
                    case 4:
                        ...
                        if (!Validator.isString(strInput, min, max)) throw new IllegalArgumentException("Lỗi: Chuỗi không hợp lệ!");
                        System.out.println("Chuỗi bạn vừa nhập là: " + strInput);
                        break;
                    case 5:
                        System.out.println("Nhập vào true/false: ");
                        String boolInput = scanner.nextLine();
                        if (!Validator.isBoolean(boolInput)) throw new IllegalArgumentException("Lỗi: Bạn phải nhập true/false!");
                        System.out.println("Giá trị boolean bạn vừa nhập là: " + boolInput);
                        break;
                    case 6:
                        System.out.println("Nhập vào 1 email: ");
                        String emailInput = scanner.nextLine();
                        if (!Validator.isEmail(emailInput)) throw new IllegalArgumentException("Lỗi: Bạn phải nhập email hợp lệ!");
                        System.out.println("Email bạn vừa nhập là: " + emailInput);
                        break;
                    case 7:
                        System.out.println("Nhập vào 1 số điện thoại của Việt Nam: ");
                        String phoneInput = scanner.nextLine();
                        if (!Validator.isPhone(phoneInput)) throw new IllegalArgumentException("Lỗi: Bạn phải nhập số điện thoại hợp lệ!");
